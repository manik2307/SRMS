...
<nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
                <a class="nav-link" href="addstudent.php">Reload This Page</a>
            </li>
            <li class="nav-item">
    ...
    <h2>
      ...
      <label for="section">Enter Student Id:</label>
        ...
        <label for="className">Enter Student Name :</label>
        ...
        <input type="number" class="form-control" placeholder="Enter class Id like 101,102,..etc"required="required" name="Roll">
      </div>
    ...
    <?php
        ...
        $sameSql = "SELECT * FROM `tblstudents` WHERE `StudentId` = '$student_id' AND `StudentName` = '$student_name' AND `ClassId` = '$class_id'";
        ...
        $addstudentSql = "INSERT INTO `tblstudents` (`StudentId`, `StudentName`, `RollNo`, `ClassId`) VALUES ('$student_id', '$student_name', '$roll_no', '$class_id')";
        $studentAddResult = mysqli_query($conn, $addstudentSql);

        if($studentAddResult){
            echo "<script>
                        alert('Added Successfully');
                        window.location.href='http://localhost/SRMS/addstudent.php';
                </script>";
        }
        else {
