...
<nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
                <a class="nav-link" href="addsubcomb.php">Reload This Page</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="updatesubcomb.php">UPDATE SUBJECT</a>
            </li>
            </ul>
        </div>
        </nav>
    ...
    <h2>
        ...
        <form action="addsubcomb.php" method="get">
    ...
    <?php
        ...
        $sameSql = "SELECT * FROM `subjectcombination` WHERE `ClassId` = '$class_id' AND `SubjectId` = '$subject_id'";
        ...
        $add_subject_sql = "INSERT INTO `subjectcombination` (`Id`, `ClassId`, `SubjectId`) VALUES (NULL, '$class_id', '$subject_id')";
        $add_subject_result = mysqli_query($conn, $add_subject_sql);

        if($add_subject_result){
            echo "<script>
                        alert('Added Successfully');
                        window.location.href='http://localhost/SRMS/addsubcomb.php';
                </script>";
        }
        else {
